...
<p align="center">
  ...
  <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/brendamatias/bootcamp-gostack-desafio-3">
...
```bash
$ git clone https://github.com/brendamatias/bootcamp-gostack-desafio-3
```

Mova-se para diretório da aplicação:

```bash
$ cd bootcamp-gostack-desafio-3
```
